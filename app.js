...
(function() {
  var adjustDarkness, adjustScale, backCode, backCopies, code, collate, copies, copyPage, cycleStaple, cycleTray, darkness, inputCode, inputCopies, load, mode, pagesCached, proto, refreshInputCopies, resetAll, scale, setMode, setPagesCached, setScale, setSheetsRequired, setStaple, setTimeRemaining, setup, sheetsRequired, staple, startOrStopCopying, startTimer, timeRemaining, toggleCollate, toggleLoad, toggleMode, tray;
