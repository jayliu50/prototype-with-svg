...
this.Prototype = (function() {
  var TEXTTOKEN, clear, computeFontSize, hide, init, initialState, states, transferAllAttributes, translateSvgAttributesToCss, triggers;
  ...
  init = function(state) {
    var hints, initialize, rectangles, view;
